      ...
      learningPath: [
        {
          ...
          recommendedCourses: [
            { title: "Advanced Microservices Patterns", provider: "Udemy", duration: "4 weeks", url: "https://www.udemy.com/course/microservices-architecture/", isPaid: true },
            { title: "System Design Primer", provider: "GitHub", duration: "Self-paced", url: "https://github.com/donnemartin/system-design-primer", isPaid: false }
          ]
        },
        {
          ...
          recommendedCourses: [
            { title: "Cloud Native Essentials", provider: "Udemy", duration: "3 weeks", url: "https://www.udemy.com/topic/cloud-computing/", isPaid: true }
          ]
        },
        {
          ...
          recommendedCourses: [
            { title: "Kubernetes for the Absolute Beginners", provider: "Udemy", duration: "2 weeks", url: "https://www.udemy.com/course/learn-kubernetes/", isPaid: true }
          ]
        }
      ]
    };
